...
<td>
<br>&nbsp;<br>
<!--Formulario que se encarga de enviar los datos al servlet EliminarUsuarioServlet-->
<form name="form1" method="post" action="EliminarUsuarioServlet">
<p>&nbsp;</p>
 ...
 %>
	...
	<p>&nbsp;</p>
    <tr>
      <td colspan="2" bgcolor="#274069"><div align="center" class="style1">Eliminar Registro de un Usuario</div></td>
    </tr>
	<tr>
    ...
    <tr>
      ...
      <td bgcolor="#E2E2E2" class="style9"><label>
        <select name="rol" id="rol" class="style9" disabled="disabled">
			<%
    ...
    <tr>
      <td><label>
        <div align="center" class="style9">
          <input name="boton" type="submit" id="Eliminar" class="style9" id="1" value="Eliminar" onclick="ValidarForm(this.form)">
          </div>
      </label></td>
	   <td><label>
        <div align="center" class="style9">
