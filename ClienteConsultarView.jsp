...
<td>
<br>&nbsp;<br>
<!--Formulario que se encarga de enviar los datos al servlet BuscadorClienteFraudeEliServlet-->
<form id="form1" name="form1" method="post"
	action="BuscadorClienteFraudeServlet">
<p>&nbsp;</p>
<table width="428" border="0" align="center">
 ...
 %>
	...
	<tr>
		...
		<td width="227" bgcolor="#274069">&nbsp;<span class="style4">Cedula
		<label> <input type="text" name="cedula" id="cedula"
...
<table width="428" border="0" align="center">
	<tr>
		...
		<td bgcolor="#E2E2E2"><label><input type="text"
			name="nombre" id="nombre" disabled="disabled"
			value="<%=frau.getNombre()%>"></label></td>
	</tr>
	<tr>
		<td class="style9" bgcolor="#E2E2E2">Apellido</td>
		<td bgcolor="#E2E2E2"><label> <input type="text"
			name="apellido" id="apellido" disabled="disabled"
			value="<%=frau.getApellido()%>"></label></td>
	</tr>
	<tr>
		<td class="style9" bgcolor="#E2E2E2">Tipo de Linea</td>
		<td bgcolor="#E2E2E2"><label> <select name="tipolinea"
			class="style9" id="tipolinea" disabled="disabled">
			<%
...
<table width="160" border="0" align="center">
	<tr>
		...
		<div align="center"><label> <input name="boton"
			...
			id="1" value="Consultar"> </label></div>
		</td>
	</tr>
</table>
</form>
