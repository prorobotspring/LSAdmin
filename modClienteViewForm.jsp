...
<title>Modificar registro de un cliente</title>
...
<td>
<br>&nbsp;<br>
<!--Formulario que se encarga de enviar los datos al servlet ModificarFraudeServlet-->
<form id="form1" name="form1" method="post" action="ModificarFraudeServlet">
...
<table width="428" border="0" align="center">
 ...
 %>
	...
	<td height="20" colspan="2" bgcolor="#274069">
		<div align="center" class="style3">Modificar Fraude</div>
	</td>
	</tr>
	<tr>
		...
		<input type="text" name="cedula" id="cedula" readonly="readonly"
...
<table width="428" border="0" align="center">
	<tr>
		...
		<td bgcolor="#E2E2E2"><label><input type="text" name="nombre" id="nombre" value="<%=frau.getNombre()%>"></label></td>
	</tr>
	<tr>
		<td class="style9" bgcolor="#E2E2E2">Apellido</td>
		<td bgcolor="#E2E2E2"><label> <input type="text" name="apellido"
			id="apellido" value="<%=frau.getApellido()%>"></label></td>
	</tr>
	<tr>
...
<table width="160" border="0" align="center">
	<tr>
		...
		<input type="button" name="Modificar" id="Modificar" class="style9" value="Modificar" onClick=" window.document.form1.boton.value='Modificar'; ValidarFormulario(this.form);">
		</label></div>
		</td>
		<td><label>
