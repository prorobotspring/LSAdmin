// JavaScript Document
	...
	var	crossobj, crossMonthObj, crossYearObj, monthSelected, yearSelected, dateSelected, omonthSelected, oyearSelected, odateSelected, monthConstructed, yearConstructed, intervalID1, intervalID2, timeoutID1, timeoutID2, ctiToPlaceValue, ctiNow, dateFormat, nStartingYear
...
//---------------------------------------------TRADUCCION EN ESPAÑOL-----------------------------------------------------------------------------
	...
	function closeCalendar() {
		...
		hideCalendar();
		ctiToPlaceValue.value =	constructDate(dateSelected,monthSelected,yearSelected)
	}
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
	...
	function popUpCalendar1(cti,ct13, format) {
		var	leftpos=-190
		var	toppos=-10
		...
		if (bPageLoaded)
		{
			if ( crossobj.visibility ==	"hidden" ) {
				...
				{
					// use user's date
					aData =	ct13.value.split(formatChar)
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
				...
				crossobj.left =	fixedX==-1 ? cti.offsetLeft	+ leftpos :	fixedX
				crossobj.top = fixedY==-1 ?	cti.offsetTop +	toppos + cti.offsetHeight +	2 :	fixedY
			...
			{
				hideCalendar()
				if (ctiNow!=cti) {popUpCalendar(cti, ct13, format)}
			}
			ctiNow = cti
		}
