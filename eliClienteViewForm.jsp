...
function ValidarAlfanumerico(cadena) {
	...
	function enviar() {
		window.location = 'ClienteConsultarModView.jsp';
	}
</script>
<style type="text/css">
.style3 {
...
<td>
<br>&nbsp;<br>
<!--Formulario que se encarga de enviar los datos al servlet EliminarFraudeServlet-->
<form id="form1" name="form1" method="post" onsubmit="return ValidarFormulario(this);" action="EliminarFraudeServlet">
<p>&nbsp;</p>
<table width="428" border="0" align="center">
 ...
 %>
	...
	<td height="20" colspan="2" bgcolor="#274069">
		<div align="center" class="style3">Eliminar Fraude</div>
	</td>
	</tr>
	<tr>
		...
		<input type="text" name="cedula" id="cedula" readonly="readonly" value="<%=frau.getCedula()%>"> </label> </span> <label>
		</label></td>
	</tr>
</table>
<table width="428" border="0" align="center">
	<tr>
		...
		<td bgcolor="#E2E2E2"><label><input type="text" name="nombre" 
		id="nombre" disabled="disabled" value="<%=frau.getNombre()%>"></label></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td bgcolor="#E2E2E2"><label> <select name="linea" class="style9" id="linea" disabled="disabled">
			<%
				if (frau.getTipolinea().equalsIgnoreCase("Prepago")) {
			%>
			<option value="1"  disabled="disabled" selected="selected">Prepago</option>
			<option value="2" disabled="disabled">Postpago</option>
			<%
				} else {
			%>

			<option value="1" disabled="disabled">Prepago</option>
			<option value="2" disabled="disabled" selected="selected">Postpago</option>
			<%
				}
			%>
		</select> </label></td>
...
<table width="160" border="0" align="center">
	<tr>
		...
		<div align="center"><label>
			<input name="boton" type="submit" id="2" class="style9" id="2" value="Eliminar">
		 </label></div>
		</td>
		<td><label>
